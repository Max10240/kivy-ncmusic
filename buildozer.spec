...
source.include_exts = py,kv,atlas,ttf,png,jpg

# (list) List of inclusions using pattern matching
source.include_patterns = src/*, NEMbox/*
...
requirements = python3,kivy,requests,lxml,pycryptodome,Pyjnius

#requirements = python3,kivy,requests,baidu-aip
...
android.ndk_path = ~/.buildozer/android/platform/android-ndk-r19b/
